        ...
        <div className="flex-1 min-w-0 max-w-md hidden md:block">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-16 py-2.5 bg-white/[0.03] border border-white/[0.06] rounded-xl text-white text-sm placeholder-gray-600 focus:outline-none focus:border-purple-500/50 transition-all font-light cursor-pointer"
            />
