...
export default function RapportsPage() {
  ...
  const reportTypes = [
    ...
    },
    {
      ...
      description: "DÃ©tails complets pour la DSI",
      icon: Building2,
      color: "cyan",
      includes: ["Tous les sites", "Historique capteurs", "Ã‰vÃ©nements", "Maintenance"],
    },
    {
      id: "incidents",
      title: "Rapport d'Incidents",
      description: "Analyse des alertes et problÃ¨mes",
      icon: AlertTriangle,
      color: "red",
      includes: ["Alertes par sÃ©vÃ©ritÃ©", "Temps de rÃ©solution", "Sites critiques", "Actions"],
    },
    {
      id: "performance",
      title: "Rapport de Performance",
      description: "MÃ©triques et optimisations",
      icon: TrendingUp,
      color: "green",
      includes: ["Uptime", "Consommation", "Tendances", "PrÃ©dictions"],
    },
  ];

  const handleGenerateReport = (reportId: string, format: "pdf" | "excel") => {
    setGenerating(true);
    toast.loading(`GÃ©nÃ©ration du rapport ${format.toUpperCase()}...`);
    
    setTimeout(() => {
      setGenerating(false);
      toast.success(`Rapport ${format.toUpperCase()} gÃ©nÃ©rÃ© avec succÃ¨s !`, {
        description: "Le tÃ©lÃ©chargement va commencer...",
      });
    }, 2000);
  };

  const periods = [
    { id: "daily", label: "Quotidien", description: "DerniÃ¨res 24h" },
      ...
      <div className="relative">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-400">GÃ©nÃ©rez des rapports professionnels pour votre Ã©quipe</p>
          </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Exports et rapports prÃ©dÃ©finis</CardDescription>
            </CardHeader>
            <CardContent className="grid md:grid-cols-3 gap-3">
              <Button
                variant="glass"
                className="justify-start"
                onClick={() => toast.success("Export CSV dÃ©marrÃ©")}
              >
                <Download className="w-4 h-4 mr-2" />
              ...
              <Button
                variant="glass"
                className="justify-start"
                onClick={() => toast.success("Export alertes dÃ©marrÃ©")}
              >
                <Download className="w-4 h-4 mr-2" />
              ...
              <Button
                variant="glass"
                className="justify-start"
                onClick={() => toast.success("Rapport automatique configurÃ©")}
              >
