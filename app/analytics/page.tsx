...
export default function AnalyticsPage() {
  ...
  const tempHistoryData = useMemo(() => Array.from({ length: 30 }, (_, i) => ({
    date: `J-${30 - i}`,
  ...
  const alertsData = useMemo(() => Array.from({ length: 7 }, (_, i) => ({
    day: `Jour ${i + 1}`,
    critical: (i * 3 + 1) % 5,
    major: (i * 2 + 3) % 10,
    minor: (i * 4 + 2) % 15,
  ...
  const sitesByTypeData = [
    ...
    { name: "Ã‰ducation", value: sites.filter(s => s.type === "education").length, color: "#FF00E5" },
    { name: "Culture", value: sites.filter(s => s.type === "culture").length, color: "#00F0FF" },
    { name: "SÃ©curitÃ©", value: sites.filter(s => s.type === "securite").length, color: "#10b981" },
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8 flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-400">Analyses dÃ©taillÃ©es et tableaux de bord</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            ...
            <Card>
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-gray-400 mb-1">TempÃ©rature Moyenne</p>
                    <p className="text-2xl font-bold gradient-text">{avgTemp.toFixed(1)}Â°C</p>
                    <div className="flex items-center gap-1 mt-1 text-xs text-red-400">
                      <TrendingUp className="w-3 h-3" />
                      <span>+0.8Â°C vs semaine</span>
                    </div>
                  </div>
            ...
            <Card>
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-gray-400 mb-1">Incidents RÃ©solus</p>
                    <p className="text-2xl font-bold gradient-text">42</p>
                    <div className="flex items-center gap-1 mt-1 text-xs text-green-400">
                      <TrendingUp className="w-3 h-3" />
                      <span>+12% efficacitÃ©</span>
                    </div>
                  </div>
            ...
            <Card>
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-gray-400 mb-1">DisponibilitÃ©</p>
          ...
          <div className="grid lg:grid-cols-2 gap-6 mb-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Ã‰volution TempÃ©rature (30 jours)</CardTitle>
                <CardDescription>TempÃ©rature moyenne, minimale et maximale</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Alertes par SÃ©vÃ©ritÃ© (7 jours)</CardTitle>
                <CardDescription>Ã‰volution des incidents</CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle>RÃ©partition des Sites</CardTitle>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Consommation Ã‰lectrique par Site</CardTitle>
